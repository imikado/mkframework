...
*/
class sgbd_pdo_firebird extends abstract_sgbd_pdo{
	...
	public function getListColumn($sTable){
		$pRs=$this->query(sgbd_syntax_firebird::getListColumn($sTable));
		$tObj=array();
	...
	public function getListTable(){
		$pRs=$this->query(sgbd_syntax_firebird::getListTable());
