...
<?php if(!_root::getRequest()->isPost()):?>
	...
	<p><?php echo tr('Builder::edit_addmodulemenu_pourCreerLeMenu')?></p>
	<p><strong><?php echo tr('Builder::edit_addmodulemenu_nomDuModule')?></strong><input type="text" name="modulename" value="menu" /></p>
	<?php if($this->bExist==1):?>
	<p style="color:red"><?php echo tr('Builder::edit_addmodulemenu_leRepertoireModuleExisteDeja')?></p>
	<?php endif;?>
	...
	<table style="margin-left:10px">
		...
		<tr>
			<th style="vertical-align:top">Module <u><?php echo $sModule?></u><p style="margin:2px;font-weight:normal;font-style:italic">(<?php echo tr('Builder::edit_addmodulemenu_classe')?> module_<?php echo $sModule?>)</p></th>
			<td>
				<table class="methods">
					<tr>
						<th></th>
						<th><?php echo tr('Builder::edit_addmodulemenu_methodeAppelee')?></th>
						<th><?php echo tr('Builder::edit_addmodulemenu_libelleDuLien')?></th>
					</tr>
	...
	<p style="text-align:right"><input type="submit" value="<?php echo tr('Builder::edit_addmodulemenu_genererLeMenu')?>"/></p>
<?php endif;?>
