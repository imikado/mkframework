...
class module_mods_scBootstrap_model extends abstract_moduleBuilder {

	protected $sModule = 'mods_scBootstrap_model';
	protected $sModuleView = 'mods/scBootstrap/model';
