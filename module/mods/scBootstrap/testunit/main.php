...
class module_mods_scBootstrap_testunit extends abstract_moduleBuilder {

	protected $sModule = 'mods_scBootstrap_testunit';
	protected $sModuleView = 'mods/scBootstrap/testunit';
