...
class module_mods_scBootstrap_sgbdXml extends abstract_moduleBuilder {

	protected $sModule = 'mods_scBootstrap_sgbdXml';
	protected $sModuleView = 'mods/scBootstrap/sgbdXml';
