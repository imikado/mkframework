...
<form action="" method="POST" class="form-signin" role="form">
	...
	<p><button class="btn btn-lg btn-primary btn-block" type="submit"><?php echo tr('seConnecter') ?></button> <a class="btn btn-link" href="<?php echo _root::getLink('VARmoduleParentENDVAR_VARmoduleChildENDVAR::inscription') ?>"><?php echo tr('inscription') ?></a></p>
