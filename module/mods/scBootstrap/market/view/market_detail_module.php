<?php echo $this->sHead ?>
<?php
module_mods_scBootstrap_market::$idModule = $this->id;
?>
...
<div class="market">
	...
	<?php if ($this->content and strlen($this->content) > 5): ?>
		<p><?php echo module_mods_scBootstrap_market::formate($this->content) ?></p>
	<?php endif; ?>

	<?php if ($this->presentation and strlen($this->presentation) > 5): ?>
		<h3><?php echo tr('presentation') ?></h3>
		<p><?php echo module_mods_scBootstrap_market::formate($this->presentation) ?></p>
	<?php endif; ?>
