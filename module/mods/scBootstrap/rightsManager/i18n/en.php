...
plugin_i18n::add(array(
	...
	'voilaSchemaDeNotreBase'=>'To manage your application rights, we will create our database',
	'codesql'=>'Code SQL',

	'selectFieldFkGroupId'=>'Field FK group id',
	'selectFieldName'=>'Field name',
	'selectFieldFkItemId'=>'Field FK item id',
	'selectFieldFkActionId'=>'Field FK action id',

	'moduleParent'=>'parent module',
	'moduleAuth'=>' authentification module',
	'moduleRightsManager'=>' acl module',
	'model_rightManager'=>' model acl classe',
