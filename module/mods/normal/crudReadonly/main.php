<?php
class module_mods_normal_crudReadonly extends abstract_moduleBuilder{

	protected $sModule='mods_normal_crudReadonly';
	protected $sModuleView='mods/normal/crudReadonly';
