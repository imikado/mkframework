<?php
class module_mods_normal_crudEmbeddedReadonly extends abstract_moduleBuilder{

	protected $sModule='mods_normal_crudEmbeddedReadonly';
	protected $sModuleView='mods/normal/crudEmbeddedReadonly';
