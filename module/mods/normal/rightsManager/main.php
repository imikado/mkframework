<?php
class module_mods_normal_rightsManager extends abstract_moduleBuilder{

	protected $sModule='mods_normal_rightsManager';
	protected $sModuleView='mods/normal/rightsManager';
