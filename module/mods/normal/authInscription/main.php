<?php
class module_mods_normal_authInscription extends abstract_moduleBuilder{

	protected $sModule='mods_normal_authInscription';
	protected $sModuleView='mods/normal/authInscription';
