<?php
class module_mods_normal_moduleEmbedded extends abstract_moduleBuilder{

	protected $sModule='mods_normal_moduleEmbedded';
	protected $sModuleView='mods/normal/moduleEmbedded';
