<?php
class module_mods_normal_rightsManagerMulti extends abstract_moduleBuilder{

	protected $sModule='mods_normal_rightsManagerMulti';
	protected $sModuleView='mods/normal/rightsManagerMulti';
	...
	private function process(){
        ...
        if (substr($classModelGroupUser,0,6) != 'model_') {
            $classModelGroupUser = 'Model\\'.$classModelGroupUser;
        }
