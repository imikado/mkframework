<?php
class module_mods_bootstrap_crudReadonly extends abstract_moduleBuilder{

	protected $sModule='mods_bootstrap_crudReadonly';
	protected $sModuleView='mods/bootstrap/crudReadonly';
