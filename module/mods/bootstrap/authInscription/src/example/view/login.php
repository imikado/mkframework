<form action="" method="POST"  class="form-signin" role="form">
	...
	<input type="submit" value="Se connecter"  class="btn btn-lg btn-primary btn-block"/> <a class="btn btn-link" href="<?php echo _root::getLink('#MODULE#::inscription')?>">S'inscrire</a></p>
