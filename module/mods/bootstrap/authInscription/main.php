<?php
class module_mods_bootstrap_authInscription extends abstract_moduleBuilder{

	protected $sModule='mods_bootstrap_authInscription';
	protected $sModuleView='mods/bootstrap/authInscription';
	...
	private function process(){
		...
		/*SOURCE*/$oSourceMain->setPattern('#row_example#',$sRowName);
		/*SOURCE*/$oSourceMain->setPattern('#oExample#',$oExample);

		/*SOURCE*/$oSourceMain->setPattern('#auth_login#',$sViewName);

		/*SOURCE*/$oSourceMain->setPattern('#auth_inscription#',$sViewInscriptionName);
		/*SOURCE*/$oSourceMain->setPattern('#loginField#',$sLoginField);
		/*SOURCE*/$oSourceMain->setPattern('#passField#',$sPassField);
		...
		/*SOURCE*/$oSourceViewLogin=$this->getObjectSource('example/view/inscription.php');
		/*SOURCE*/$oSourceViewLogin->setPattern('#MODULE#',$sModuleName);
		/*SOURCE*/$oSourceViewLogin->setPattern('#loginField#',$sLoginField);
		/*SOURCE*/$oSourceViewLogin->save();
