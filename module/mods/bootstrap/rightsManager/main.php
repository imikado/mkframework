<?php
class module_mods_bootstrap_rightsManager extends abstract_moduleBuilder{

	protected $sModule='mods_bootstrap_rightsManager';
	protected $sModuleView='mods/bootstrap/rightsManager';
	...
	private function process(){
		...
		//requete requeteFindListByGroup
		/*SOURCE*/$oSourceModel=$this->getObjectSource('model_rightsManager.php');
		$exampleRequeteFindListByGroup=$oSourceModel->getSnippet('requeteFindListByGroup',array(
		...
		/*SOURCE*/$oSourceModel->setPattern('#exampleRequeteFindListByGroup#',$exampleRequeteFindListByGroup);
