...
<p>
	Confirmez-vous la suppression ? <input class="btn btn-success" type="submit" value="Oui" /> <a class="btn btn-danger" href="<?php echo $this->getLink('#examplemodule#::list')?>">Non</a>
</p>
