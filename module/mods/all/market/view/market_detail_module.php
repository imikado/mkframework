...
<div class="market">
	...
	<form action="<?php echo module_mods_all_market::getInstallLinkModule($this->id,$this->version)?>" method="POST">
	
		<a href="<?php echo _root::getLink('builder::edit',array('id'=>_root::getParam('id'),'action'=>'mods_all_market::index',  'saction'=>'install','market'=>'normal_list_1'  ) )?>#createon"><?php echo tr('retour')?></a> <input type="submit" value="<?php echo tr('install')?>"/>
	</form>
</div>