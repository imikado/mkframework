<?php
class module_moduleCrudEmbeddedWithBootstrap{
	...
	public function _index(){
		...
		$oTpl= new _Tpl('moduleCrudEmbeddedWithBootstrap::index');
	...
	private function genModelMain($sModule,$sTableName,$sClass,$tColumn,$tCrud){
		...
		$oFile=new _file('data/sources/fichiers/module/crudembeddedWithBootstrap/main.php');
		$sContent=$oFile->getContent();
		
		$oVar=simplexml_load_file('data/sources/fichiers/module/crudembeddedWithBootstrap/main.php.xml');
		...
		$sContent=module_builder::getTools()->stringReplaceIn(
									$tReplace,
									'data/sources/fichiers/module/crudembeddedWithBootstrap/main.php'
		);
	...
	private function genModelTpl($sModule,$sClass,$tColumn,$sTableName,$tCrud,$tLabel){
		...
		foreach($tTpl as $sTpl){
			...
			$oFile=new _file('data/sources/fichiers/module/crudembeddedWithBootstrap/view/'.$sTpl.'.php');
			$sContent=$oFile->getContent();	
			
			$oVar=simplexml_load_file('data/sources/fichiers/module/crudembeddedWithBootstrap/view/'.$sTpl.'.php.xml');
				...
				$sContent=module_builder::getTools()->stringReplaceIn(
											$tReplace,
											'data/sources/fichiers/module/crudembeddedWithBootstrap/view/'.$sTpl.'.php'
				);
