<?php
class module_moduleCrudReadonlyBootstrap{
	...
	public function _index(){
		...
		$oTpl= new _Tpl('moduleCrudReadonlyBootstrap::index');
	...
	private function genModelMainCrudReadonly($sModule,$sTableName,$sClass,$tColumn){
		...
		$oFile=new _file('data/sources/fichiers/module/crudreadonlyBootstrap/main.php');
		...
		$sContent=module_builder::getTools()->stringReplaceIn(array(
									...
									'data/sources/fichiers/module/crudreadonlyBootstrap/main.php'
		);
	...
	private function genModelTplCrudReadonly($sModule,$sClass,$tColumn,$sTableName){
		...
		foreach($tTpl as $sTpl){
			...
			$oFile=new _file('data/sources/fichiers/module/crudreadonlyBootstrap/view/'.$sTpl.'.php');
			$sContent=$oFile->getContent();	
				...
				$sContent=module_builder::getTools()->stringReplaceIn(array(
											...
											'data/sources/fichiers/module/crudreadonlyBootstrap/view/'.$sTpl.'.php'
				);
