...
class module_builder extends abstract_module{
	...
	public function _crudreadonly(){
		...
		$oTpl= new _Tpl('builder::crudreadonly');
	...
	public function genModelMainCrudReadonly($sModule,$sTableName,$sClass,$tColumn){
		//$tColumn=_root::getParam('tColumn');
		$tType=_root::getParam('tType');
	...
	public function _crudembeddedreadonly(){
	    $this->rootAddConf('conf/connexion.ini.php');
		$msg='';
		$detail='';
		$oDir=new _dir(_root::getConfigVar('path.generation')._root::getParam('id').'/model/');
		...
		$oTpl= new _Tpl('builder::crudembeddedreadonly');
	...
	public function _authmodule(){
	
		$tMessage=$this->genAuthModule();
		...
		$oTpl= new _Tpl('builder::authmodule');
		$oTpl->tRowMethodes=$tRowMethodes;
	...
	private function genAuthModule(){
		if(!_root::getRequest()->isPost()){
			return null;
		}
		...
		$this->projetmkdir('module/'.$sModuleName);
		...
		$this->projetmkdir('module/'.$sModuleName.'/view');
	...
	public function genModelTplCrudReadonly($sModule,$sClass,$tColumn,$sTableName){
		//$tColumn=_root::getParam('tColumn');
		$tType=_root::getParam('tType');
