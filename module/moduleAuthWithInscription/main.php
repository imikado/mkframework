...
class module_moduleAuthWithInscription{
	...
	private function generate(){
		...
		$sContent=module_builder::getTools()->stringReplaceIn(array(
									...
									'data/sources/fichiers/module/authwithinscription/main.php'
		);
		...
		$sContent=module_builder::getTools()->stringReplaceIn(array(
									...
									'data/sources/fichiers/module/authwithinscription/view/login.php'
		);
		...
		$sContent=module_builder::getTools()->stringReplaceIn(array(
									...
									'data/sources/fichiers/module/authwithinscription/view/inscription.php'
		);
