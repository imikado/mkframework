<?php
class module_moduleAuthBootstrap{
	...
	public function _index(){
		...
		$oTpl= new _Tpl('moduleAuthBootstrap::index');
	...
	private function generate(){
		...
		$sContent=module_builder::getTools()->stringReplaceIn(array(
									...
									'data/sources/fichiers/module/authBootstrap/main.php'
		);
		...
		$oFile=new _file('data/sources/fichiers/module/authBootstrap/view/login.php');
