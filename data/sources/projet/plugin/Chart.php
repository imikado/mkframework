...
use Plugin\ChartPart\ChartPie;
use Plugin\ChartPart\ChartHisto;
use Plugin\ChartPart\ChartLine;
use Plugin\ChartPart\ChartBar;
...
class Chart
{
    ...
    public function __construct($sType, $iWidth = null, $iHeight = null)
    {
        ...
        if ($sType == self::PIE) {
            $this->oChart = new ChartPie($this->iWidth, $this->iHeight);
        } else if ($sType == self::HISTO) {
            $this->oChart = new ChartHisto($this->iWidth, $this->iHeight);
        } else if ($sType == self::LINES) {
            $this->oChart = new ChartLine($this->iWidth, $this->iHeight);
        } else if ($sType == self::BAR) {
            $this->oChart = new ChartBar($this->iWidth, $this->iHeight);
        } else {
