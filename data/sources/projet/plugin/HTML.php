...
class HTML
{
    ...
    public function getInputDate($sName, $sValue = null, $tOption = null)
    {
        ...
        if ($sValue != null && preg_match('/-/', $sValue)) {
    ...
    {
        if (!isset($tPost[$sName . '_annee']) || !isset($tPost[$sName . '_mois']) || !isset($tPost[$sName . '_jour'])
            || $tPost[$sName . '_annee'] == '' || $tPost[$sName . '_mois'] == '' || $tPost[$sName . '_jour'] == ''
        ) {
            return null;
        }
