...
<table>
	...
	<tr>
		<th>priority</th>
		<td><input name="priority" value="<?php echo $this->oArticle->priority ?>" /><?php if($this->tMessage and isset($this->tMessage['priority'])): echo implode(',',$this->tMessage['priority']); endif;?></td>
	</tr>
