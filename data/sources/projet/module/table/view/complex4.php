		...
		<tr>
			...
			<th <?php if($this->tClassColumn and isset($this->tClassColumn[$i])):?>class="<?php echo $this->tClassColumn[$i]?>"<?php endif;?> style="vertical-align:top"><?php echo $tDetail['label']?><br />
				<?php if(isset($tDetail['order'])):?>
					<a href="<?php echo module_table::getLink(null,array('order'=>$tDetail['order'],'side'=>'asc',$sVarPage=>$sValuePage))?>"><img src="css/images/flecheUp<?php if($sParamOrder==$tDetail['order'] and $sParamSide=='asc'):?>On<?php else:?>Off<?php endif;?>.png"/></a> 
					<a href="<?php echo module_table::getLink(null,array('order'=>$tDetail['order'],'side'=>'desc',$sVarPage=>$sValuePage))?>"><img src="css/images/flecheDown<?php if($sParamOrder==$tDetail['order'] and $sParamSide=='desc'):?>On<?php else:?>Off<?php endif;?>.png"/></a> 
				<?php endif;?></th>
			<?php endforeach;?>
		</tr>
	</thead>
