...
*/
/**
* Plugin\sc\ACL classe de gestion de droits
* @author Mika
* @link http://mkf.mkdevs.com/
*/
class ACL implements interface_acl{
	...
	*/
	public function can($action,$ressource){
		...
		if(!isset($this->tabAllowDeny[$ressource][$action]) ){
			$ok=false;
		}else if(isset($this->tabAllowDeny[$ressource][$action]) && $this->tabAllowDeny[$ressource][$action]==0 ){
			$ok=false;
		}
