...
class module_examplemodule extends abstract_module{
	...
	private function processEdit(){
		...
		$sGroupText=trim(_root::getParam('exampleGroupId_text'));
		$sActionText=trim(_root::getParam('exampleActionId_text'));
		$sItemText=trim(_root::getParam('exampleItemId_text'));
